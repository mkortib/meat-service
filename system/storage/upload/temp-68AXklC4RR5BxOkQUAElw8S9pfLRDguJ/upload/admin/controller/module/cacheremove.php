...
class ControllerModuleCacheremove extends Controller {
	...
	public function index() {
		$this->language->load('module/cacheremove');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/cacheremove', 'token=' . $this->session->data['token'], true),
		);

		$data['action']	 = $this->url->link('module/cacheremove', 'token=' . $this->session->data['token'], true);
		$data['cancel']	 = $this->url->link('module/cacheremove', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('module/cacheremove.tpl', $data));
	}
